...
exports.details = function(id, cb) {
  ...
  var detail_handler = new htmlparser.DefaultHandler(
    function(err, dom) {
      ...
      require("soupselect").select(detail_handler.dom, "p").forEach(function(el) {
      ...
      var details = {id: null, title: null, category: null, url: null, time: null, comment: null, website: null, submitter: null};
      var current_detail = "";
